        ...
        <div className="sm-px-32 pl-12 m-0 " style={{ maxWidth: "1440px" }}>
          <div className="pb-24 d-flex justify-content-center">
            <div className="input-group mt-24  " style={{ maxWidth: "423px" }}>
              <button
                className="btn bg-white radius-l-8 border-top border-bottom border-start "
                type="button"
              >
              ...
              <input
                type="text"
                className="form-control border-top border-bottom border-top"
                placeholder="Search anything here"
                style={{ borderRight: "none" }}
              />

              <div className="p-1 radius-r-8 bg-white  border-top border-bottom border-end">
                <button className="btn bg-warning " type="button">
                  Search
                </button>
              </div>
            </div>
