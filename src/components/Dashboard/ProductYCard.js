...
const ProductYCard = () => {
  return (
    <div className="sm-w-432 w-300 xs-mr-10 sm-mr-15 flex-grow-0 book-shadow radius-14 flex-shrink-0  d-flex gap-20 align-items-center p-1">
      <div
      ...
      <div className="">
        <h6 className="m-0 font-size-14 md-font-size-16">
          English Escalate - Fourth
        </h6>
        <p className="text-neutral-300 m-0 xs-pb-0  md-pb-24 md-pb-24 font-size-11 md-font-size-14">
          Atlaz
        </p>
        <div className="d-flex justify-content-between pb-0 md-pb-24">
          <div>
            <h6 className="m-0 text-center font-size-12 sm-font-size-16">6</h6>
            <p className="m-0 text-neutral-200 xs-pb-0  md-pb-24   font-size-9 md-font-size-12">
              Lesson
            </p>
          </div>
          <div>
        ...
        <div className="d-flex gap-2 align-items-center font-size-14 ">
          <h5 className="font-size-14 md-font-size-16">Rp 120.000</h5>
          <p className="text-neutral-200 m-0 font-size-9 md-font-size-12">
            <s>Rp 999.999</s>
          </p>
        </div>
      </div>
