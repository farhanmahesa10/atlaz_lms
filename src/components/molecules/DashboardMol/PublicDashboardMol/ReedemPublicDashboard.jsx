      ...
      <div className="d-flex align-items-center flex-column flex-md-row">
        ...
        <div className="xl-ml-22 mt-24 md-mt-0">
          ...
          <p className=" font-xs md-font-sm xl-font-normal mt-16 md-h-116">
            You haven't started studying the book you have, let's start now. If
            you don't have a digital book, you can buy it by clicking the shop
            menu or exchanging your book code on redeem.
          </p>
