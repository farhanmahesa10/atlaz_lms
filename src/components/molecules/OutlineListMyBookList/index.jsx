...
import OutlineListLessonControlMyBookList from "./OutlineListLessonControlMyBookList";
import { GET, defConfig } from "../../../config/RestAPI";
const OutlineListMyBookList = (props) => {
  ...
  useEffect(() => {
    setIsLoading(true);
    GET(`/booklist/detail/${subjectId}`, defConfig())
      .then((r) => {
        setData(r.data.lessons);
        setLessonData(r.data.lessons.find((res) => res._id === lessonId));
...
export default OutlineListMyBookList;
