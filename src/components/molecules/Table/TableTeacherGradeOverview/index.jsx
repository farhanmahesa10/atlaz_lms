                            ...
                            return <tr>
                              ...
                              <td width="14%">
                                <div className="d-flex">
                                  {item.score ? item.score : 'N/A'} <Link to={`detail/${item.subject._id}/${item.classlist._id}`} onClick={() => setTableOption()}><Launch className="text-neutral-100 fs-18 ml-6" /></Link></div>
                              </td>
                            </tr>
                          }) : (<tr>
