...
import { LessonPreviewLoading, OutlineList } from "../../../molecules";
            ...
            <div className="mt-40 d-flex align-items-center flex-column">
              ...
              <div className="mt-16 md-mt-24">
                ...
                {data.topic && data.topic.subtopic ? (
                  <>
                    <Link
                      to={`/classroom/content-practice/${params.classId}/${params.subjectId}/${params.lessonId}/${data.topic._id}/${data.topic?.subtopic?._id}`}
              ...
              <div className="mt-24 md-mt-40 d-flex w-full justify-content-between justify-content-md-center">
                <div className="d-flex  md-mr-68 w-148">
                  {!pagination.prev ? (
                    ...
                    <Link
                      to={`/classroom/lesson-preview/${params.classId}/${params.subjectId}/${pagination.prev._id}`}
                      className="d-flex"
                    >
                ...
                {!pagination.next ? (
                  ...
                  <Link
                    to={`/classroom/lesson-preview/${params.classId}/${params.subjectId}/${pagination.next._id}`}
                    className="d-flex"
                  >
                    <div className="mr-8 d-flex justify-content-between flex-column ">
