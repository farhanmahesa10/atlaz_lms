...
import { 
  DoubleArrowRounded, ArrowForward, ArrowBack
              ...
              <div className="col-md-8 col-12 mt-96">
                <div className="row justify-content-center">
                  <div className="col-4 d-flex align-items-center">
                    <button className="btn-disable cursor-pointer p-7 mr-8"><ArrowBack className="fs-20" /></button>
                    <div className="one-row">
                      <div className="font-xs text-neutral-200">Back</div>
                      <div className="font-xs-medium text-neutral-400">Reading 1</div>
                    </div>
                  </div>
                  <div className="col-4 d-flex align-items-center justify-content-end text-end">
                    <div className="one-row">
                      ...
                      <div className="font-xs-medium text-neutral-400">Reading 3</div>
                    </div>
                    <button className="btn-secondary cursor-pointer p-7 ml-8"><ArrowForward className="fs-20" /></button>
                  </div>
                </div>
              </div>
