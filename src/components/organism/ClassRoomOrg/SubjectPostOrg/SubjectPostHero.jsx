              ...
              <div>
                ...
                <div className="d-flex">
                  ...
                  <Can allowAccess="teacher">
                    {
                      (data.lessonPlanSchool || data.lessonPlanSchool !== '') && (<a href={data.lessonPlanSchool} target="_blank" className="ml-8 btn-secondary font-normal d-flex align-items-center">
